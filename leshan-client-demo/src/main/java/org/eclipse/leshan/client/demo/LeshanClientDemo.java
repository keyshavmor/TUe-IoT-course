...
public class LeshanClientDemo {
    ...
    private static final int PARKING_SPOT_ID = 32700;
    ...
    public static void createAndStartClient(String endpoint, String localAddress, int localPort, boolean needBootstrap,
        ...
        initializer.setInstancesForObject(PARKING_SPOT_ID, new ParkingSpot());
        List<LwM2mObjectEnabler> enablers = initializer.create(SECURITY, SERVER, DEVICE, LOCATION,PARKING_SPOT_ID,
